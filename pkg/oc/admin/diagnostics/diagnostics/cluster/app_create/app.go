...
func (d *AppCreate) createAndTestAppDC() bool {
	result := &d.result.App
	...
	result.Success = d.testPodRunning()
...
func (d *AppCreate) createAppDC() bool {
	...
	_, err := d.AppsClient.Apps().DeploymentConfigs(d.project).Create(dc)
	if err != nil {
...
func (d *AppCreate) testPodRunning() bool {
