...
func (d *AppCreate) createAndTestRoute() {
...
func (d *AppCreate) testRoute() bool {

	if !d.testRouteAdmitted() {
		return false
	}
	...
	return d.testRouteConnection()
}

func (d *AppCreate) testRouteAdmitted() bool {
...
// test that we get the expected HTTP response from the route
func (d *AppCreate) testRouteConnection() bool {
	...
	if err := d.testHttp(url, d.httpTimeout, d.httpRetries); err != nil {
