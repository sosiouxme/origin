...
func commandRunFunc(o optionsRunner) func(c *cobra.Command, args []string) {
	return func(c *cobra.Command, args []string) {
		...
		if err := o.BuildAndRunDiagnostics(); err != nil {
...
// BuildAndRunDiagnostics builds diagnostics based on the options and executes them. Returns:
// error (raised during construction of diagnostics; may be an aggregate error object),
func (o DiagnosticsOptions) BuildAndRunDiagnostics() error {
